package com.picodiploma.newsapp.util
...
object DateFormatter {
    ...
    fun formateDate(currentDate: String): String? {
        val currentFormate = "yyyy-MM-dd'T'hh:mm:ss'Z'"
        val targetFormat = "dd MMM yyyy | HH:mm"
        val timezone = "GMT"
        val currentDf: DateFormat = SimpleDateFormat(currentFormate, Locale.getDefault())
        ...
        try {
            ...
            if(date != null) targetDate = targetDf.format(date)
