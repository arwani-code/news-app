...
import com.picodiploma.newsapp.data.Result
import com.picodiploma.newsapp.databinding.FragmentNewsBinding
...
class NewsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val newsAdapter = NewsAdapter{ news ->
            if(news.isBookMarked) viewModel.deleteNews(news)
